...
const ModalAddSpecie: FC = () => {
  // Флаг, открыта ли форма
  const show = useAppSelector((state) => state.userReducer.modalAddSpecie);
  const { setShowModalAddSpecie, setIsReloadTable } = userSlice.actions;
  ...
  const handleClose = (): void => {
    dispatch(setShowModalAddSpecie(false));
